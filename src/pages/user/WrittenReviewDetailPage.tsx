...
export const WrittenReviewDetailPage = () => {
  return (
    <section className="laptop:my-4 mobile:my-0">
      ...
      <div className="flex flex-col gap-4 laptop:w-[500px] min-h-[735px]    mobile:w-full mx-auto laptop:border laptop:border-gray-300  laptop:py-10 laptop:px-6 mobile:p-4 rounded-lg">
        <div className="flex flex-col gap-3">
          <h2 className="font-bold">호스트/게스트 소개</h2>
          {/* host/guest infobox */}
          <div className="flex gap-2 items-center">
            <div className="w-11 h-11 bg-gray-300 rounded-full"></div>
            <div>
              <h2 className="font-bold">어니언수제어묵 님</h2>
          ...
          <div className="p-4">
            <ul className="list-disc">
              <li>경기 진행이 매끄럽습니다.</li>
              <li>심판을 잘 봐주셔서 재미있게 경기했습니다.</li>
              <li>음료수를 준비해주셔서 편하게 경기했습니다.</li>
              <li>그냥 다 좋아요!</li>
            </ul>
          </div>
