      ...
      <section className="bg-secondary-black  md:pt-[3.75rem] md:pb-[6.25rem]  md:space-y-[100px]">
        <div className="md:w-[767px] sm:w-full sm:p-5 md:p-0 sm:space-y-[22px] md:space-y-[42px] mx-auto">
          <div className="space-y-5">
            <h1 className="text-white text-[32px] font-semibold ">문의하기</h1>
          ...
          <div className="flex justify-center items-center gap-5">
            ...
            <div className="flex items-center gap-1">
              {/* #737373 */}
              {/* #7FEEF0 */}
              <button type="button" className="p-2.5 text-[#7FEEF0]">
                1
              </button>
              <button type="button" className="p-2.5 text-[#737373 ]">
                1
              </button>
            </div>
            <button type="button">
          ...
          <Link
            to="new"
            className="w-[768px] h-12 p-2.5 bg-[#7feef0] rounded-lg justify-center items-center gap-2.5 inline-flex"
          >
