export const AdvertisementBanner = () => {
  return (
    <div className="bg-gray-200 relative mobile:w-screen mobile:px-[4rem] mobile:h-[200px] mobile:mb-[5rem] tablet:w-[1024px] tablet:h-[180px] border border-2-[#E8E8E8] rounded-xl my-[40px]">
